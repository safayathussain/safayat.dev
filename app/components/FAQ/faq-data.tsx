...
export const faqData: FAQ[] = [
  {
    ...
    answer: (
      <>
        A great developer portfolio is more than a <a href={SITE_NAP.profiles.resume} target="_blank" className="underline font-medium text-white hover:text-slate-300">resume</a>; it&apos;s a live demonstration of your skills and philosophies. This site, for example, isn&apos;t
