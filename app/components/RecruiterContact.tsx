        ...
        >
          <div className="flex w-fit items-center gap-3 p-2 max-lg:justify-center">
            <div className="relative h-12 w-12 overflow-hidden rounded-full ring-4 ring-slate-200">
              <Image src={profilePhoto} alt="Safayat Hussain Chowdhury" fill sizes="80px" className="object-cover object-top" />
            </div>
          ...
          <div className="flex flex-col items-center gap-4 max-lg:items-center">
            ...
            <Text className="max-w-2xl text-center text-balance">
              I build fast, accessible web apps with React, Next.js and Express.js. I&apos;m looking for teams that value product quality, performance, and
              thoughtful UX.
            </Text>
          </div>
          ...
          <div className="flex items-center gap-3  max-lg:justify-center  ">
            ...
            <WhiteButtonLink href={SITE_NAP.profiles.resume} className="relative text-black font-semibold" target="_blank">
              Resume
            </WhiteButtonLink>
          </div>
        </MotionDiv>
